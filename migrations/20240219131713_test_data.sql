...
INSERT INTO items
    (id, name, size, quantity, created_at)
VALUES
    ('f2aaa171-0118-497b-a0f3-bcffb82533f1', 'dress', 'S', 10, now()),
...
INSERT INTO stocks
    (id, name, is_available, created_at)
VALUES
    ('5fe06170-4fb3-429a-b950-1ae1a037376e', 'moscow', true, now()),
...
INSERT INTO items_stocks
    (stock_id, item_id, quantity, created_at)
VALUES
    ('5fe06170-4fb3-429a-b950-1ae1a037376e', 'f2aaa171-0118-497b-a0f3-bcffb82533f1', 5, now()),
